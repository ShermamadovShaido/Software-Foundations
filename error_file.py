...
def process_student_results(students_data):
    ...
    for student in students_data:
        ...
        if average is not None:
            ...
            pass_fail = "Congratulations, you passed!" if average >= 70 else "Fail"
...
def write_results_to_csv(results, filename):
    ...
    if results:
        ...
        header = ['name', 'math', 'science', 'english', 'average', 'grade', 'math_grade', 'science_grade',
                  'english_grade', 'min_score', 'max_score', 'score_range', 'pass_fail']
